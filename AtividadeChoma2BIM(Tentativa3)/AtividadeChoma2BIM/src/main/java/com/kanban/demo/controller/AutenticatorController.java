...
import com.kanban.demo.dto.AutenticatorRequest;
import com.kanban.demo.dto.AutenticatorResponse;
...
public class AutenticatorController{
    ...
    @PostMapping("/login")
    public ResponseEntity<?> login(@RequestBody AutenticatorRequest request) {
        try {
            ...
            return ResponseEntity.ok(new AutenticatorResponse(token));
        } catch (Exception e) {
